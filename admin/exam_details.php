...
<head>
    ...
    @media print {
            ...
            @page {
                margin: 0;
                size: landscape; /* Set page to landscape orientation */
            }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 mt-1">
                    ...
                    <div class="col-md-12">
                        <?php
                        if (isset($_GET["date"]) && isset($_GET["sub_code"]) && isset($_GET["lab_category"])) {
                            $date = $_GET["date"];
                            $sub_code = $_GET["sub_code"];
                            $department = $_GET["department"];
                            $lab_category = $_GET["lab_category"];
                            $sql2 = "SELECT * FROM exam WHERE date='$date' AND sub_code='$sub_code' AND department='$department' AND lab_category='$lab_category'";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <table class="table table-bordered mt-2 table-sm" style="font-size:13px;">
                                    <tr>
                                        ...
                                        <th>Name & designation <br>External / Internal / lab_technician / skilled assistent</th>
                                        <th>Faculty Id</th>
                                        <th>College name</th>
                                    ...
                                    ?>
                                    <tr>
                                    <td><?= ($type == 'ox') ? '<strong>OTHER EXPENSES</strong>' : $row[$type . "_name"] . " / " . $row[$type . "_designation"] . " / " . get_designation($type) ?></td>
                            ...
                            <table class="table table-bordered mt-2 table-sm" style="font-size:13px;">
                                ...
                                <?php
                                    ...
                                    <?php
                                        foreach ($types as $type) {
                                    ?>
                                    <td><?= $row[$type . "_name"] . " / " . $row[$type . "_designation"] . " / " . get_designation($type) ?></td>
